...
public class GalagaGame extends JPanel implements KeyListener {
	...
	private int alienshotdelay=100;
	...
	private void alienFire() {
		...
		AlienShotSprite shot1 = new AlienShotSprite(this,alienshotImage,alien.x,alien.y);
		sprites.add(shot1);
	...
	public void fire() {
		ShotSprite shot = new ShotSprite(this, shotImage, starship.getX() + 50, starship.getY() - 30);
		sprites.add(shot);
	}
	

	public void boom() {
		Boom boom = new Boom(this, boomImage, starship.getX() + 50, starship.getY() - 30);
		sprites.add(boom);
	}
